...
const ROWS: Row[] = [
  {
    route: ["Cairo → Alexandria (Talgo)", "القاهرة ← الإسكندرية (تالجو)"],
    distanceKm: 208,
    secondAc: 175,
    firstAc: 275,
  },
  {
    route: ["Cairo → Alexandria (Spanish/French AC)", "القاهرة ← الإسكندرية (إسباني/فرنسي مكيف)"],
    distanceKm: 208,
    secondAc: 140,
    firstAc: 220,
  },
  {
    route: ["Cairo → Alexandria (Russian AC)", "القاهرة ← الإسكندرية (روسي مكيف)"],
    distanceKm: 208,
    third: 75,
    secondAc: 140,
  },
  {
    route: ["Cairo → Tanta", "القاهرة ← طنطا"],
    distanceKm: 94,
    third: 40,
    secondAc: 70,
    firstAc: 105,
  ...
  {
    route: ["Cairo → Mansoura", "القاهرة ← المنصورة"],
    distanceKm: 190,
    third: 70,
    secondAc: 130,
    firstAc: 195,
  ...
  {
    route: ["Cairo → Ismailia", "القاهرة ← الإسماعيلية"],
    distanceKm: 140,
    third: 60,
    secondAc: 105,
  },
  ...
  {
    route: ["Cairo → Minya", "القاهرة ← المنيا"],
    distanceKm: 245,
    third: 100,
    secondAc: 175,
    firstAc: 265,
  ...
  {
    route: ["Cairo → Asyut", "القاهرة ← أسيوط"],
    distanceKm: 375,
    third: 140,
    secondAc: 240,
    firstAc: 365,
  ...
  {
    route: ["Cairo → Sohag", "القاهرة ← سوهاج"],
    distanceKm: 470,
    third: 170,
    secondAc: 275,
    firstAc: 420,
  ...
  {
    route: ["Cairo → Marsa Matrouh (summer)", "القاهرة ← مرسى مطروح (صيفي)"],
    distanceKm: 468,
    secondAc: 220,
    firstAc: 340,
  },
  {
    route: ["Cairo → Luxor (day express)", "القاهرة ← الأقصر (نهاري سريع)"],
    distanceKm: 671,
    secondAc: 315,
    firstAc: 485,
  },
  {
    route: ["Cairo → Aswan (day express)", "القاهرة ← أسوان (نهاري سريع)"],
    distanceKm: 879,
    secondAc: 385,
    firstAc: 590,
  },
  {
    ...
    sleeperSingle: 2200,
    note: [
      "Fare per person, includes dinner and breakfast.",
      "السعر للفرد، ويشمل العشاء والإفطار.",
    ],
  },
  {
    route: ["Alexandria → Marsa Matrouh", "الإسكندرية ← مرسى مطروح"],
    distanceKm: 290,
    secondAc: 170,
    firstAc: 260,
  },
  {
    route: ["Alexandria → Port Said", "الإسكندرية ← بورسعيد"],
    distanceKm: 235,
    third: 90,
    secondAc: 130,
  },
  ...
  {
    route: ["Alexandria → Mansoura", "الإسكندرية ← المنصورة"],
    distanceKm: 175,
    third: 65,
    secondAc: 115,
  },
  ...
  {
    route: ["Ismailia → Port Said", "الإسماعيلية ← بورسعيد"],
    distanceKm: 92,
    third: 35,
    secondAc: 60,
  },
  ...
  {
    route: ["Luxor → Aswan", "الأقصر ← أسوان"],
    distanceKm: 208,
    third: 75,
    secondAc: 140,
    firstAc: 215,
...
function FaresPage() {
  ...
  return (
    ...
    >
      ...
      >
        <Info
          className="mt-0.5 size-5 shrink-0 text-[color:var(--color-text-brand)]"
          aria-hidden="true"
        />
        <p>
          {bi(
      ...
      <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div className="flex-1">
          <label
            htmlFor="fare-search"
            className="mb-1.5 block text-sm font-semibold text-[color:var(--color-text-brand)]"
          >
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={bi(
                "e.g. Cairo, Alexandria, Luxor…",
                "مثال: القاهرة، الإسكندرية، الأقصر…",
              )}
          ...
          <p
            id="fare-search-hint"
            aria-live="polite"
            className="mt-1 text-xs text-[color:var(--color-text-secondary)]"
          >
            {bi(
              `${filtered.length} of ${ROWS.length} routes shown`,
              `${filtered.length} من ${ROWS.length} مسارًا معروضًا`,
            )}
          </p>
        </div>
        <div
          role="group"
          aria-label={bi("Filter by class", "تصفية حسب الدرجة")}
      ...
      <div className="overflow-x-auto rounded-2xl border border-[color:var(--color-border-default)] bg-[color:var(--color-background-elevated)] shadow-sm">
        <table className="w-full min-w-[720px] border-collapse text-start text-sm">
          <caption className="sr-only">
            {bi(
              "Indicative ENR fares by route and class in Egyptian pounds.",
              "أسعار استرشادية لتذاكر الهيئة حسب المسار والدرجة بالجنيه المصري.",
            )}
          </caption>
          <thead className="bg-[color:var(--color-brand-primary-tint)] text-[color:var(--color-text-brand)]">
            <tr>
              ...
              <th scope="col" className="px-4 py-3 text-end font-semibold">
                {bi("3rd class", "الدرجة الثالثة")}
              </th>
              <th scope="col" className="px-4 py-3 text-end font-semibold">
                {bi("2nd class AC", "الدرجة الثانية مكيّف")}
              </th>
              <th scope="col" className="px-4 py-3 text-end font-semibold">
                {bi("1st class AC", "الدرجة الأولى مكيّف")}
              </th>
              <th scope="col" className="px-4 py-3 text-end font-semibold">
                {bi("Sleeper (double)", "نوم (مزدوج)")}
              </th>
              <th scope="col" className="px-4 py-3 text-end font-semibold">
                {bi("Sleeper (single)", "نوم (فردي)")}
              </th>
            </tr>
          </thead>
          <tbody>
            {filtered.map((r) => (
              <tr key={r.route[0]} className="border-t border-[color:var(--color-border-default)]">
                <th
                  scope="row"
                  className="px-4 py-3 text-start font-semibold text-[color:var(--color-text-primary)]"
                >
                  {bi(r.route[0], r.route[1])}
                  {r.note && (
                    <span className="mt-1 block text-xs font-normal text-[color:var(--color-text-secondary)]">
                      {bi(r.note[0], r.note[1])}
                    </span>
                  )}
                </th>
                <td className="px-4 py-3 text-end tabular-nums text-[color:var(--color-text-secondary)]">
                  {r.distanceKm} km
                </td>
                <td className="px-4 py-3 text-end tabular-nums">
                  {r.third ? `${r.third} ${currency}` : dash}
                </td>
                <td className="px-4 py-3 text-end tabular-nums">
                  {r.secondAc ? `${r.secondAc} ${currency}` : dash}
                </td>
                <td className="px-4 py-3 text-end tabular-nums">
                  {r.firstAc ? `${r.firstAc} ${currency}` : dash}
                </td>
                <td className="px-4 py-3 text-end tabular-nums">
                  {r.sleeperDouble ? `${r.sleeperDouble} ${currency}` : dash}
                </td>
                <td className="px-4 py-3 text-end tabular-nums">
                  {r.sleeperSingle ? `${r.sleeperSingle} ${currency}` : dash}
                </td>
              </tr>
            ))}
          </tbody>
