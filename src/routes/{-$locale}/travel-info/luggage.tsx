...
function LuggagePage() {
  ...
  const items = [
    bi(
      "One large bag (up to 30kg) free per passenger",
      "حقيبة كبيرة واحدة (حتى 30 كجم) مجاناً لكل راكب",
    ),
    ...
    bi(
      "Dangerous goods and large livestock prohibited",
      "يُمنع نقل المواد الخطرة والماشية الكبيرة",
    ),
  ];
  return (
    <StubPage
      ...
      subtitle={bi(
        "What you can bring on board ENR services.",
        "ما يُسمح لك بحمله على متن خدمات الهيئة.",
      )}
    >
