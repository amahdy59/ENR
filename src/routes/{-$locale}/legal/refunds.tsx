...
function RefundsPage() {
  ...
  return (
    <StubPage
      ...
      breadcrumbs={[{ label: bi("Legal", "قانوني") }, { label: bi("Refunds", "الاسترداد") }]}
    >
      <article className="prose prose-sm max-w-none space-y-6 text-[color:var(--color-text-primary)]">
        <div className="rounded-xl border-l-4 border-[color:var(--color-brand-secondary)] bg-[color:var(--color-brand-primary-tint)] p-4 text-sm">
          <p className="font-semibold text-[color:var(--color-text-brand)]">
            {bi(
              "Draft — pending confirmation from ENR customer services.",
              "مسودة — بانتظار التأكيد من خدمة عملاء الهيئة.",
            )}
          </p>
        </div>
          ...
          <ul className="list-disc space-y-1 ps-6">
            <li>
              {bi(
                ...
                "أكثر من 24 ساعة قبل المغادرة: استرداد كامل.",
              )}
            </li>
            <li>
              {bi(
                "6–24 h before departure: 75% refund.",
                "من 6 إلى 24 ساعة قبل المغادرة: استرداد 75%.",
              )}
            </li>
            <li>
              {bi(
                "Less than 6 h before departure: 50% refund.",
                "أقل من 6 ساعات قبل المغادرة: استرداد 50%.",
              )}
            </li>
