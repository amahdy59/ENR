...
export type FareClassCode =
  | "3rd" | "2nd-ac" | "1st-ac" | "vip"
  | "sleeper-double" | "sleeper-single";
...
const MANUAL_TRIPS: readonly Trip[] = [
  ...
  { number: "903",  kind: "spanish-ac", from: "cairo-central",   to: "alexandria-misr",
    depart: "06:00", arrive: "09:30", duration: { en: "3h 30m", ar: "3س 30د" },
    days: "daily", stops: ["benha", "quesna", "tanta", "damanhur", "sidi-gaber"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_CAI_ALX },
  // Delta all-stops regional Cairo↔Alex via Quesna (indicative).
  { number: "555",  kind: "russian-ac", from: "cairo-central",   to: "alexandria-misr",
    depart: "10:15", arrive: "14:40", duration: { en: "4h 25m", ar: "4س 25د" },
    days: "daily", stops: ["benha", "quesna", "tanta", "kafr-el-zayat", "damanhur", "sidi-gaber"],
    fares: [{ klass: "3rd", priceEgp: 75 }, { klass: "2nd-ac", priceEgp: 140 }],
    source: "Indicative — Delta regional service" },
  { number: "557",  kind: "russian",    from: "cairo-central",   to: "alexandria-misr",
    depart: "16:45", arrive: "21:20", duration: { en: "4h 35m", ar: "4س 35د" },
    days: "daily", stops: ["benha", "quesna", "tanta", "damanhur", "sidi-gaber"],
    fares: [{ klass: "3rd", priceEgp: 65 }],
    source: "Indicative — Delta regional service" },
  { number: "556",  kind: "russian-ac", from: "alexandria-misr", to: "cairo-central",
    depart: "07:20", arrive: "11:45", duration: { en: "4h 25m", ar: "4س 25د" },
    days: "daily", stops: ["sidi-gaber", "damanhur", "tanta", "quesna", "benha"],
    fares: [{ klass: "3rd", priceEgp: 75 }, { klass: "2nd-ac", priceEgp: 140 }],
    source: "Indicative — Delta regional service" },
  { number: "2025", kind: "vip-talgo",  from: "cairo-central",   to: "alexandria-misr",
    depart: "08:00", arrive: "10:30", duration: { en: "2h 30m", ar: "2س 30د" },
    days: "daily", stops: ["tanta", "sidi-gaber"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_CAI_ALX },
  { number: "901",  kind: "vip-talgo",  from: "cairo-central",   to: "alexandria-misr",
    depart: "08:10", arrive: "11:15", duration: { en: "3h 05m", ar: "3س 05د" },
    days: "daily", stops: ["tanta", "sidi-gaber"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_CAI_ALX },
  { number: "2023", kind: "vip-talgo",  from: "cairo-central",   to: "alexandria-misr",
    depart: "14:00", arrive: "16:30", duration: { en: "2h 30m", ar: "2س 30د" },
    days: "daily", stops: ["tanta", "sidi-gaber"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_CAI_ALX },
  { number: "2027", kind: "vip-talgo",  from: "cairo-central",   to: "alexandria-misr",
    depart: "19:00", arrive: "21:30", duration: { en: "2h 30m", ar: "2س 30د" },
    days: "daily", stops: ["tanta", "sidi-gaber"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_CAI_ALX },

  // Northbound (Alexandria → Cairo). Talgo 2022/2024/2026 explicitly named in seat61.
  { number: "2022", kind: "vip-talgo",  from: "alexandria-misr", to: "cairo-central",
    depart: "07:00", arrive: "09:30", duration: { en: "2h 30m", ar: "2س 30د" },
    days: "daily", stops: ["sidi-gaber", "tanta"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_ALX_CAI },
  { number: "2024", kind: "vip-talgo",  from: "alexandria-misr", to: "cairo-central",
    depart: "14:00", arrive: "16:30", duration: { en: "2h 30m", ar: "2س 30د" },
    days: "daily", stops: ["sidi-gaber", "tanta"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_ALX_CAI },
  { number: "2026", kind: "vip-talgo",  from: "alexandria-misr", to: "cairo-central",
    depart: "18:50", arrive: "21:20", duration: { en: "2h 30m", ar: "2س 30د" },
    days: "daily", stops: ["sidi-gaber", "tanta"],
    fares: [{ klass: "2nd-ac", priceEgp: 175 }, { klass: "1st-ac", priceEgp: 275 }],
    source: SRC_ALX_CAI },
  ...
  { number: "980",  kind: "vip-talgo",  from: "cairo-central", to: "aswan",
    depart: "08:00", arrive: "22:25", duration: { en: "14h 25m", ar: "14س 25د" },
    days: "daily",
    stops: ["giza", "beni-suef", "minya", "asyut", "sohag", "nag-hammadi", "qena", "luxor", "edfu", "kom-ombo"],
    fares: [{ klass: "2nd-ac", priceEgp: 315 }, { klass: "1st-ac", priceEgp: 485 }],
    source: SRC_CAI_ASW },
  { number: "2030", kind: "vip-talgo",  from: "cairo-central", to: "aswan",
    depart: "19:00", arrive: "06:35", nextDayArrival: true,
    duration: { en: "11h 35m", ar: "11س 35د" }, days: "daily",
    stops: ["giza", "beni-suef", "minya", "asyut", "sohag", "qena", "luxor", "edfu", "kom-ombo"],
    fares: [{ klass: "2nd-ac", priceEgp: 315 }, { klass: "1st-ac", priceEgp: 485 }],
    source: SRC_CAI_ASW },
  { number: "86",   kind: "sleeper",    from: "cairo-upper-egypt", to: "aswan",
    depart: "19:45", arrive: "09:25", nextDayArrival: true,
    duration: { en: "13h 40m", ar: "13س 40د" }, days: "daily",
    stops: ["giza", "asyut", "sohag", "qena", "luxor", "edfu", "kom-ombo"],
    fares: [{ klass: "sleeper-double", priceEgp: 1700 }, { klass: "sleeper-single", priceEgp: 2200 }],
    source: SRC_CAI_ASW },
  { number: "1086", kind: "sleeper",    from: "cairo-upper-egypt", to: "aswan",
    depart: "19:20", arrive: "08:35", nextDayArrival: true,
    duration: { en: "13h 15m", ar: "13س 15د" }, days: "daily", // "extra, as required"
    stops: ["giza", "asyut", "sohag", "qena", "luxor", "edfu", "kom-ombo"],
    fares: [{ klass: "sleeper-double", priceEgp: 1700 }, { klass: "sleeper-single", priceEgp: 2200 }],
    source: SRC_CAI_ASW },
  { number: "1088", kind: "sleeper",    from: "alexandria-misr", to: "aswan",
    depart: "19:20", arrive: "12:00", nextDayArrival: true,
  ...
  { number: "981",  kind: "vip-talgo",  from: "aswan", to: "cairo-central",
    depart: "05:30", arrive: "19:40", duration: { en: "14h 10m", ar: "14س 10د" },
    days: "daily",
    stops: ["kom-ombo", "edfu", "luxor", "qena", "nag-hammadi", "sohag", "asyut", "minya", "beni-suef", "giza"],
    fares: [{ klass: "2nd-ac", priceEgp: 315 }, { klass: "1st-ac", priceEgp: 485 }],
    source: SRC_ASW_CAI },
  { number: "2031", kind: "vip-talgo",  from: "aswan", to: "cairo-central",
    depart: "19:00", arrive: "07:05", nextDayArrival: true,
    duration: { en: "12h 05m", ar: "12س 05د" }, days: "daily",
    stops: ["kom-ombo", "edfu", "luxor", "qena", "sohag", "asyut", "minya", "beni-suef", "giza"],
    fares: [{ klass: "2nd-ac", priceEgp: 315 }, { klass: "1st-ac", priceEgp: 485 }],
    source: SRC_ASW_CAI },
  { number: "87",   kind: "sleeper",    from: "aswan", to: "cairo-upper-egypt",
    depart: "17:15", arrive: "05:42", nextDayArrival: true,
    duration: { en: "12h 27m", ar: "12س 27د" }, days: "daily",
    stops: ["kom-ombo", "edfu", "luxor", "qena", "sohag", "asyut", "giza"],
    fares: [{ klass: "sleeper-double", priceEgp: 1700 }, { klass: "sleeper-single", priceEgp: 2200 }],
    source: SRC_ASW_CAI },
  { number: "1089", kind: "sleeper",    from: "aswan", to: "alexandria-misr",
    depart: "19:40", arrive: "11:20", nextDayArrival: true,
  ...
  { number: "939",  kind: "russian",    from: "cairo-central", to: "marsa-matruh",
    depart: "05:45", arrive: "13:30", duration: { en: "7h 45m", ar: "7س 45د" },
    ...
    source: SRC_MATRUH },
  { number: "1205", kind: "russian-ac", from: "cairo-central", to: "marsa-matruh",
    depart: "06:45", arrive: "15:25", duration: { en: "8h 40m", ar: "8س 40د" },
    days: "daily",
    stops: ["tanta", "damanhur", "sidi-gaber", "el-alamein", "el-dabaa", "fuka"],
    fares: [{ klass: "3rd", priceEgp: 110 }, { klass: "2nd-ac", priceEgp: 170 }],
    source: SRC_MATRUH },
  { number: "773",  kind: "russian",    from: "cairo-central", to: "marsa-matruh",
    depart: "22:35", arrive: "06:20", nextDayArrival: true,
    duration: { en: "7h 45m", ar: "7س 45د" }, days: "daily", // Note B (unverified)
    stops: ["tanta", "damanhur", "sidi-gaber", "el-alamein", "el-dabaa", "fuka"],
    fares: [{ klass: "3rd", priceEgp: 90 }],
    source: SRC_MATRUH },
  { number: "648",  kind: "russian",    from: "alexandria-moharam-bek", to: "marsa-matruh",
    depart: "07:30", arrive: "12:40", duration: { en: "5h 10m", ar: "5س 10د" },
    days: "daily",
  ...
  { number: "3015", kind: "russian-ac", from: "cairo-central", to: "port-said",
    depart: "04:50", arrive: "09:00", duration: { en: "4h 10m", ar: "4س 10د" },
    days: "daily", stops: ["benha", "zagazig", "ismailia", "el-qantara"],
    fares: [{ klass: "3rd", priceEgp: 90 }, { klass: "2nd-ac", priceEgp: 130 }],
    source: SRC_PORT },
  { number: "945",  kind: "russian",    from: "cairo-central", to: "port-said",
    depart: "06:10", arrive: "10:30", duration: { en: "4h 20m", ar: "4س 20د" },
    days: "daily", stops: ["benha", "zagazig", "ismailia", "el-qantara"],
    fares: [{ klass: "3rd", priceEgp: 65 }],
    source: SRC_PORT },
  { number: "185",  kind: "russian-ac", from: "cairo-central", to: "port-said",
    depart: "09:10", arrive: "13:05", duration: { en: "3h 55m", ar: "3س 55د" },
    days: "daily", stops: ["benha", "zagazig", "ismailia", "el-qantara"],
    fares: [{ klass: "3rd", priceEgp: 90 }, { klass: "2nd-ac", priceEgp: 130 }],
    source: SRC_PORT },
  { number: "951",  kind: "russian",    from: "cairo-central", to: "port-said",
    depart: "11:30", arrive: "16:05", duration: { en: "4h 35m", ar: "4س 35د" },
    days: "daily", stops: ["benha", "zagazig", "ismailia", "el-qantara"],
    fares: [{ klass: "3rd", priceEgp: 65 }],
    source: SRC_PORT },
  { number: "955",  kind: "russian-ac", from: "cairo-central", to: "port-said",
    depart: "14:40", arrive: "19:05", duration: { en: "4h 25m", ar: "4س 25د" },
    days: "daily", stops: ["benha", "zagazig", "ismailia", "el-qantara"],
    fares: [{ klass: "3rd", priceEgp: 90 }, { klass: "2nd-ac", priceEgp: 130 }],
    source: SRC_PORT },
  ...
  { number: "593",  kind: "russian",    from: "cairo-central", to: "suez",
    depart: "05:00", arrive: "10:00", duration: { en: "5h 00m", ar: "5س 00د" },
    days: "daily", stops: ["zagazig", "ismailia"],
    fares: [{ klass: "3rd", priceEgp: 75 }],
    source: SRC_SUEZ },
  { number: "4603", kind: "russian",    from: "cairo-adly-mansour", to: "suez",
    depart: "05:00", arrive: "10:15", duration: { en: "5h 15m", ar: "5س 15د" },
    days: "daily", stops: ["ismailia"],
    fares: [{ klass: "3rd", priceEgp: 55 }],
    source: SRC_SUEZ },
  { number: "4605", kind: "russian",    from: "cairo-adly-mansour", to: "suez",
    depart: "15:00", arrive: "20:14", duration: { en: "5h 14m", ar: "5س 14د" },
    days: "daily", stops: ["ismailia"],
    fares: [{ klass: "3rd", priceEgp: 55 }],
    source: SRC_SUEZ },
  ...
  { number: "641",  kind: "russian-ac", from: "cairo-central", to: "mansoura",
    depart: "07:30", arrive: "10:20", duration: { en: "2h 50m", ar: "2س 50د" },
    days: "daily", stops: ["benha", "zagazig", "mit-ghamr", "aga"],
    fares: [{ klass: "3rd", priceEgp: 60 }, { klass: "2nd-ac", priceEgp: 95 }],
    source: "Indicative — not sourced from seat61" },
  { number: "649",  kind: "russian-ac", from: "cairo-central", to: "damietta",
    depart: "15:15", arrive: "19:10", duration: { en: "3h 55m", ar: "3س 55د" },
    days: "daily", stops: ["benha", "zagazig", "mansoura", "talkha"],
    fares: [{ klass: "3rd", priceEgp: 70 }, { klass: "2nd-ac", priceEgp: 110 }],
    source: "Indicative — not sourced from seat61" },
  { number: "531",  kind: "russian",    from: "cairo-central", to: "mahalla-el-kubra",
    depart: "07:00", arrive: "09:50", duration: { en: "2h 50m", ar: "2س 50د" },
    days: "daily", stops: ["benha", "tanta", "samannoud"],
    fares: [{ klass: "3rd", priceEgp: 55 }],
    source: "Indicative — not sourced from seat61" },
  ...
  { number: "3024", kind: "spanish-ac", from: "quesna", to: "cairo-central",
    depart: "11:19", arrive: "12:10", duration: { en: "0h 51m", ar: "0س 51د" },
    days: "daily", stops: ["benha"],
    fares: [{ klass: "2nd-ac", priceEgp: 50 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "1212", kind: "russian", from: "quesna", to: "cairo-central",
    depart: "12:20", arrive: "13:35", duration: { en: "1h 15m", ar: "1س 15د" },
    days: "daily", stops: ["berket-el-sabaa", "shibin-el-kom", "toukh", "qalyub", "benha"],
    fares: [{ klass: "3rd", priceEgp: 30 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "132", kind: "russian", from: "quesna", to: "cairo-central",
    depart: "13:12", arrive: "14:20", duration: { en: "1h 08m", ar: "1س 08د" },
    days: "daily", stops: ["berket-el-sabaa", "toukh", "benha"],
    fares: [{ klass: "3rd", priceEgp: 30 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "914", kind: "spanish-ac", from: "quesna", to: "cairo-central",
    depart: "15:25", arrive: "16:20", duration: { en: "0h 55m", ar: "0س 55د" },
    days: "daily", stops: ["benha"],
    fares: [{ klass: "2nd-ac", priceEgp: 90 }, { klass: "1st-ac", priceEgp: 120 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "1208", kind: "russian", from: "quesna", to: "cairo-central",
    depart: "16:20", arrive: "17:20", duration: { en: "1h 00m", ar: "1س 00د" },
    days: "daily", stops: ["qalyub", "benha"],
    fares: [{ klass: "3rd", priceEgp: 30 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "956", kind: "russian-ac", from: "quesna", to: "cairo-central",
    depart: "17:10", arrive: "18:10", duration: { en: "1h 00m", ar: "1س 00د" },
    days: "daily", stops: ["qalyub", "benha"],
    fares: [{ klass: "3rd", priceEgp: 30 }, { klass: "2nd-ac", priceEgp: 50 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "24", kind: "russian", from: "quesna", to: "cairo-central",
    depart: "17:26", arrive: "18:40", duration: { en: "1h 14m", ar: "1س 14د" },
    days: "daily", stops: ["berket-el-sabaa", "shibin-el-kom", "toukh", "qalyub", "benha"],
    fares: [{ klass: "3rd", priceEgp: 30 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "994", kind: "spanish-ac", from: "quesna", to: "cairo-central",
    depart: "19:30", arrive: "20:25", duration: { en: "0h 55m", ar: "0س 55د" },
    days: "daily", stops: ["benha"],
    fares: [{ klass: "2nd-ac", priceEgp: 60 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "32", kind: "russian", from: "quesna", to: "cairo-central",
    depart: "21:30", arrive: "22:25", duration: { en: "0h 55m", ar: "0س 55د" },
    days: "daily", stops: ["benha"],
    fares: [{ klass: "3rd", priceEgp: 30 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "968", kind: "russian", from: "quesna", to: "cairo-central",
    depart: "22:50", arrive: "23:50", duration: { en: "1h 00m", ar: "1س 00د" },
    days: "daily", stops: ["qalyub", "benha"],
    fares: [{ klass: "3rd", priceEgp: 30 }],
    source: "ENR Tickets app • Quesna→Cairo, Jul 2026" },
  { number: "28", kind: "russian", from: "quesna", to: "cairo-central",
    depart: "23:01", arrive: "00:15", nextDayArrival: true,
...
export async function findTrips(fromId: string, toId: string): Promise<TripMatch[]> {
  ...
  for (const trip of TRIPS) {
    ...
    out.push({ ...trip, duration: trip.duration!, nextDayArrival: trip.nextDayArrival ?? false, direct, intermediateStops: Math.max(0, b - a - 1) });
  }
...
export async function departuresFrom(stationId: string): Promise<TripMatch[]> {
  ...
  const rows = TRIPS.filter((t) => t.from === stationId || t.stops?.includes(stationId))
    .map((t) => ({ ...t, duration: t.duration!, nextDayArrival: t.nextDayArrival ?? false, direct: t.from === stationId, intermediateStops: 0 }))
...
export const DAYS_OF_WEEK: readonly { en: string; ar: string; short: { en: string; ar: string } }[] = [
